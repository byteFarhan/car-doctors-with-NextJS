    ...
    <>
      ...
      >
        <div className="flex gap-5">
          <Image src={calenderIcon} alt="calender Icon" draggable={false} />
        ...
        <div className="flex gap-5">
          <Image src={phoneIcon} alt="phone Icon" draggable={false} />
          <div className="space-y-2">
        ...
        <div className="flex gap-5">
          <Image src={locationIcon} alt="location Icon" draggable={false} />
          <div className="space-y-2">
