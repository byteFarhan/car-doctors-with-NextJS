    ...
    <>
      <section className="mt-6 mb-16 md:mb-20 lg:mt-10 lg:mb-32">
        <div className="relative">
          <div className="absolute rounded-[10px] h-full w-full lg:w-2/3 bg-[linear-gradient(90deg,_#151515_0%,_rgba(21,21,21,0)_100%)] flex items-center lg:justify-start text-center p-6 lg:pl-24">
            <h3 className="text-white w-full lg:w-auto font-bold text-2xl md:text-4xl text-center lg:text-[45px]">
              {title}
            </h3>
          </div>
          <Image
          ...
          <div className="relative flex justify-center">
            <div className="bg-primary absolute bottom-0 px-3 lg:px-5 w-2/4 md:w-1/3 lg:w-1/4 py-20 lg:py-28 mx-auto [clip-path:polygon(5%_81%,_95%_81%,_100%_100%,_0%_100%)] flex justify-center">
              <p className="absolute pt-4 text-sm font-medium text-center text-white md:text-base lg:text-xl bottom-1">
                {pagePath}
              </p>
            </div>
          </div>
